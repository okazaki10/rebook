...
class PembelianController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = DB::table('list_buku')->join('detail_buku','list_buku.id_buku','=','detail_buku.id')->select('list_buku.id','list_buku.id_penjual','detail_buku.judul','list_buku.stok','detail_buku.gambar','detail_buku.harga')->get();  
    ...
    {
        $list_buku = DB::table('list_buku')->join('detail_buku','list_buku.id_buku','=','detail_buku.id')->join('user','list_buku.id_penjual','=','user.id')->select('list_buku.id','list_buku.id_penjual','detail_buku.judul','list_buku.stok','detail_buku.gambar','user.nama_lengkap','user.alamat','detail_buku.harga')->where('list_buku.id',$id)->first();  
        $user = Helper::auth(Session::get('email'),Session::get('password'));

...
class KeranjangBelanjaController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = DB::table('keranjang_belanja')
        ->join('list_buku', 'list_buku.id', '=', 'keranjang_belanja.id_list_buku')
        ->join('detail_buku', 'list_buku.id_buku', '=', 'detail_buku.id')
        ->select('keranjang_belanja.id', 'keranjang_belanja.jumlah', 'keranjang_belanja.harga', 'detail_buku.judul', 'detail_buku.gambar', 'keranjang_belanja.harga')->where('id_user', $user->id)->where('id_status', '0')->get();

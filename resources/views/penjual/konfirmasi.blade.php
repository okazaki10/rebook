        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Belum dikirim</td>
              <td><a href="{{action('StatusKonfirmasiController@edit', $konfirmasi['id'])}}" class="btn btn-warning">Lihat</a></td>
              @else
              <td>Belum dikirim</td>
              <td><a href="{{action('StatusKonfirmasiController@edit', 'sewa-'.$konfirmasi['id'])}}" class="btn btn-warning">Lihat</a></td>
              @endif
              @elseif($konfirmasi['status'] == '1')
              <td class="text-success">Sudah dikirim</td>
              @elseif($konfirmasi['status'] == '2')
              <td class="text-primary">Sudah sampai</td>
              @elseif($konfirmasi['status'] == '3')
              <td class="text-danger">Batal</td>
              @elseif($konfirmasi['status'] == '4')
              <td class="text-primary">Sudah dikembalikan</td>
              @endif
